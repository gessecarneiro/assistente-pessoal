...
def monitora_audio():
	...
	with sr.Microphone() as source:
		while True:
			print('Say me something, I''m Listening:')
...
def filmes():
	url = 'https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=d682d7a06089e9d80a64245ac6cb6ab4'
...
def executa_comandos(mensagem):
	...
	# open softwares from binary
	elif 'abrir spotify' in mensagem:
		os.system('/usr/bin/spotify')
	
	elif 'abrir anydesk' in mensagem:
		os.system('/usr/bin/anydesk')
...
def main():
	cria_audio("audios/ola.mp3", "Hello, can i help you?")
	while True:
		monitora_audio()
